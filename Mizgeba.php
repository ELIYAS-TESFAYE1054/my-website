...
<html>
    ...
    <a href=""></a>
        <header>
        <form id="regForm" method="post" action="connection.php" onsubmit="return passform()"></form>
        </header>
       
        <div class="wrapper">
            <span class="icon-closed"> <ion-icon name="close-outline"></ion-icon></span>
            <div class="form-box">
                <h2 style="color: green;" class="page" >Login page</h2>
            ...
            <label>phone number</label>
                    ...
                    <div class="Remember-forget">
                        ...
                        <a href="amharic.php" style="color: green; text-decoration: none;">ለአማርኛ</a>
                    </div>
                    <a href="choose.php"><button type="submit" class="btn" name="login">Login </button></a>
                    
                    <div class="Login-register">
                        <p>Don't have an account <a href="Mizgeba.php" class="Register-link">Register</a></p>
